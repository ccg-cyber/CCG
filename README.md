...
registered and reachable from it, 49 modules are built end-to-end against
**one real shared dataset** (not 49 disconnected demos), and an "Ask CI"
...
src/
  ...
  modules/              Real implementations for the 49 live modules
scripts/
