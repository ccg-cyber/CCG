...
export const MODULES: ModuleDefinition[] = [
  ...
  { id: "ci-pdf", slug: "pdf", name: "CI PDF", replaces: "Acrobat", category: "work", status: "live",
  ...
  { id: "ci-accounting", slug: "accounting", name: "CI Accounting & Finance", category: "business", status: "live",
    ...
    keywords: ["accounting", "finance", "ledger", "budget", "journal", "cheque"] },
  ...
  { id: "ci-workflow-engine", slug: "workflow", name: "CI Workflow Engine", category: "build", status: "live",
